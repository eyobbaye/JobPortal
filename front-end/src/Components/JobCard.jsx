      ...
      <div className=" border-zinc-500 p-6 inset-shadow-sm bg-white shadow-md rounded-xl">
        <div className="">
          ...
          <div className="flex justify-between items-center gap-8">
            ...
            <h1 className="mt-4 text-gray-900 font-medium text-md">
              {job.title}
            </h1>
          </div>
        ...
        <div className="mt-4 flex gap-4 text-sm">
          <button
            ...
            className="bg-linear-to-r from-[#04336af7] to-[#084e9df7] text-white px-8 py-2 rounded-full hover:border-gray-300 hover:bg-gray-50 transition-all duration-300"
          >
            View Job
          </button>
          <button
            ...
            className="bg-amber-400 border-2 border-gray-200 text-gray-700 px-8 py-2 rounded-full  hover:border-gray-300 hover:bg-gray-50 transition-all duration-300 shadow-sm hover:shadow-md"
          >
            Applay
          </button>
        </div>
